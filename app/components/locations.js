...
import imagenBack from "../../public/portada.webp";
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-slate-50 via-white to-blue-50 relative overflow-hidden">
      <div className="mx-auto px-6 relative z-10">
        ...
        {/* Locations Grid */}
        <div
          className="relative map w-full rounded-xl mb-20"
          style={{
            backgroundImage: `url(${imagenBack.src})`,
            minHeight: "700px",
          ...
          <div className="relative flex flex-col items-end rounded-xl">
            <div className="text-center">
              <div className="textAndBtn flex flex-col items-center gap-5 rounded-xl">
                ...
                <h4 className="text-gray-200 text-lg font-thin">
                  República Argentina
                </h4>
                <Link
                  href={"https://maps.app.goo.gl/oyyFShX9P2LyCnrd9"}
                  className="p-2 bg-red-900 rounded-lg hover:bg-red-600 max-w-100"
                >
                  Ver en el mapa
                </Link>
              </div>
