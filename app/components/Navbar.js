    ...
    <header className="relative z-999">
      <nav className="bg-navInactivo backdrop-blur-md shadow-lg border-b border-transparent fixed top-0 left-0 right-0 z-50 transition-all duration-300 hover:bg-navActivo hover:border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="w-8 h-8 bg-yellow-100 rounded-lg flex items-center justify-center">
                          ...
                          >
                            <path
                              ...
                              strokeLinejoin="round"
                              strokeWidth="2"
                              d="M12 9v4m0 4h.01M4.93 19h14.14a2 2 0 001.76-3l-7.07-12a2 2 0 00-3.52 0L3.17 16a2 2 0 001.76 3z"
                            ></path>
                          </svg>
                        </div>
                        <div>
                   ...
                   {/*  <Link
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        <div className="w-8 h-8 bg-yellow-100 rounded-lg flex items-center justify-center">
                          <svg
                            className="w-6 h-6 text-pink-500 inline-block mr-2"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
          ...
          {/* Mobile menu */}
          <div
            className={`lg:hidden transition-all duration-300  bg-navResponsiveAc w-screen  z-999  hover:bg-navActivo ease-in-out fixed right-0 h-screen flex flex-col justify-end items-end ${isOpen ? " opacity-100 min-w-200" : "max-h-0 opacity-0 overflow-hidden"}`}
          >
